...
public class DijkstraAlgorithmTest {
    ...
    protected static ShortestPathSolution singleNodeDijkstraLengthMode, singleNodeDijkstraTimeMode, dijkstraBikiniLengthMode, dijkstraBikiniInfeasibleLengthMode;
    ...
    public static void initAll() throws IOException
    {
        ...
        mapCarreDense = mapDirectory + "carre-dense.mapgr";
        ...
        /*origin = graphMidiPyrenees.getNodes().get(10991);
        destination = graphMidiPyrenees.getNodes().get(63104);*/
        
        /*
         * ----------------------------------------
         * Single Node Test with Dijkstra Algorithm
         * ----------------------------------------
         */
